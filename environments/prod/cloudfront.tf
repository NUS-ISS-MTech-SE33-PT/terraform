...
moved {
  from = aws_cloudfront_response_headers_policy.admin_web_security_headers
  to   = module.cloudfront_admin_web.aws_cloudfront_response_headers_policy.hsts[0]
}

moved {
  from = aws_cloudfront_response_headers_policy.spot_submission_security_headers
  to   = module.cloudfront_spot_submission.aws_cloudfront_response_headers_policy.hsts[0]
}

moved {
  from = aws_cloudfront_origin_access_control.web_static
  to   = module.cloudfront_web_static.aws_cloudfront_origin_access_control.this
}

moved {
  from = aws_cloudfront_distribution.web_static
  to   = module.cloudfront_web_static.aws_cloudfront_distribution.this
}

moved {
  from = aws_cloudfront_origin_access_control.admin_web
  to   = module.cloudfront_admin_web.aws_cloudfront_origin_access_control.this
}

moved {
  from = aws_cloudfront_distribution.admin_web
  to   = module.cloudfront_admin_web.aws_cloudfront_distribution.this
}

moved {
  from = aws_cloudfront_origin_access_control.spot_submission
  to   = module.cloudfront_spot_submission.aws_cloudfront_origin_access_control.this
}

moved {
  from = aws_cloudfront_distribution.spot_submission
  to   = module.cloudfront_spot_submission.aws_cloudfront_distribution.this
}
